          ...
          >
            ...
            <div className="pt-6">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.instagram.com/isparklesolutions?utm_source=qr"
                  target="_blank"
                ...
                <a
                  href="https://www.facebook.com/share/17qMhwWHiM/?mibextid=wwXIfr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-full border border-primary/50 flex items-center justify-center hover:bg-primary hover:border-primary transition-all group"
                >
                ...
                <a
                  href="https://vt.tiktok.com/ZSX6sfgDG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-full border border-primary/50 flex items-center justify-center hover:bg-primary hover:border-primary transition-all group"
                >
